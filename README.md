...
113. [[React,Github Actions] create-react-app のアプリケーションを GithubActions でビルドするときに`Treating warnings as errors because process.env.CI = true.` と怒られる時の対処法](https://qiita.com/shunexe/items/db928b490c77a8b03248)
